...
#define PITNN_V1_NOM        400.0f      /* Nominal primary bus voltage   (V) */
#define PITNN_V2_NOM        250.0f      /* Nominal secondary bus voltage (V) */
#define PITNN_N_TURNS       1.6f        /* Transformer turns ratio n=V1/V2   */
#define PITNN_FSW           100000.0f   /* Switching frequency          (Hz) */
#define PITNN_LK            40e-6f      /* Series inductance             (H) */
#define PITNN_P_RATED       3300.0f     /* Rated power                   (W) */
 ...
 * Example for 12-bit ADC, 3.3V reference:
 *   V1=400V: 1:150 voltage divider → scale = (3.3/4095)*150 = 0.1209
 *   V2=250V: 1:100 voltage divider → scale = (3.3/4095)*100 = 0.0806
 *   iL:      20A Hall sensor range → scale = 20/4095 = 0.0049           */
#define PITNN_ADC_V1_SCALE  0.1209f     /* Counts → primary bus voltage  (V) */
#define PITNN_ADC_V2_SCALE  0.0806f     /* Counts → secondary bus voltage(V) */
#define PITNN_ADC_IL_SCALE  0.0049f     /* Counts → inductor current     (A) */
...
/* Outer PI controller gains — tune for your 400V/250V/3.3kW converter     */
